...
const DTCHero = () => {
  const metrics = [
    {
      icon: <ShoppingBag size={24} className="text-prometheus-gold" aria-hidden="true" />,
      value: "-28%",
      label: "Customer Acquisition Cost"
    },
    {
      icon: <TrendingUp size={24} className="text-prometheus-gold" aria-hidden="true" />,
      value: "+47%",
      label: "Conversion Rates"
    },
    {
      icon: <Users size={24} className="text-prometheus-gold" aria-hidden="true" />,
      value: "+120%",
      label: "Customer LTV"
    }
  ];
  ...
  return (
    <section className="pt-24 pb-16 bg-gradient-to-br from-white to-gray-50" aria-labelledby="dtc-hero-heading">
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="text-left">
            <h1 id="dtc-hero-heading" className="text-4xl md:text-5xl font-semibold text-prometheus-navy mb-6 leading-tight">
            ...
            {/* Metrics */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-8" aria-label="Key Performance Metrics">
          ...
          <div className="relative">
            <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden shadow-lg">
              <img 
                ...
                alt="DTC marketing team collaborating on customer data analysis and growth strategies" 
